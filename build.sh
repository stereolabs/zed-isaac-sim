...
BUILD_PATH="_build/linux-x86_64/release/exts/sl.sensor.camera.bridge/bin/"
...
cp -r $BUILD_PATH/* "exts/sl.sensor.camera.bridge/bin/"

cp "exts/sl.sensor.camera.bridge/bin/libsl_zed.so" "$BUILD_PATH/libsl_zed.so"
