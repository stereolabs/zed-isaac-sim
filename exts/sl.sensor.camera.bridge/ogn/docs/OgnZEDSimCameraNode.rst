...
.. csv-table::
    ...
    "Linear Acceleration (*inputs:linearAcceleration*)", "``float[3]``", "imu acceleration", "[0.0, 0.0, 0.0]"
    "Orientation (*inputs:orientation*)", "``float[4]``", "imu orientation", "[0.0, 0.0, 0.0, 1.0]"
