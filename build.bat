...
set "BUILD_PATH=_build/windows-x86_64/release/exts/sl.sensor.camera.bridge/bin"
...
xcopy /e /i /y "%BUILD_PATH%\*" "exts\sl.sensor.camera.bridge\bin"

copy /y "exts\sl.sensor.camera.bridge\bin\sl_zed64.dll" "%BUILD_PATH%\sl_zed64.dll" 